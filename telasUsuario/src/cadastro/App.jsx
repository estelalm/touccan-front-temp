...
function App() {
  ...
  const formatTelefone = (value) => {
    return value
      ...
      .replace(/(\d)(\d{4})$/, '$1-$2') // Adiciona o hífen no final
  ...
  const formatCPF = (value) => {
    return value
      ...
      .replace(/(\d{2})$/, '-$1') // Adiciona o hífen
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between' }}>
            <div style={{ flex: 1, marginRight: '10px' }}>
              ...
              <div>
                ...
                <input type="text" name="telefone" value={formData.telefone} onChange={handleInputChange} placeholder=" " maxLength={15} />
                {erros.telefone && <p style={{ color: 'red' }}>{erros.telefone}</p>}
              </div>
              <div>
                <img src="./img/cpf.png" alt="CPF" width={18} />
                <input type="text" name="cpf" value={formData.cpf} onChange={handleInputChange} placeholder="" maxLength={14} />
